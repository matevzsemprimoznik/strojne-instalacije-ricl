...
const About = () => {
    return (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mt-5 container mx-auto mb-14 lg:mb-28">
            <div className="p-4 flex lg:flex-col flex-col-reverse order-2 lg:order-1">
            ...
            <div className="flex flex-col px-4 pb-5 pt-10 order-1 lg:order-2">
