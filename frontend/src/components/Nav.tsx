    ...
    return (
        <div className='flex py-8 container m-auto justify-between'>
            ...
            <div className='flex mx-5'>
                <Link className='hover:underline text-lg text-white' href="/projekti">Projekti</Link>
                <Link className='ml-12 hover:underline text-lg text-white' href="/o-nas">O nas</Link>
            </div>
        </div>
    )
}
