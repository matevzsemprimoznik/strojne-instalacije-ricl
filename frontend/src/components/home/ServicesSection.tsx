...
const ServicesSection = () => {
    ...
    return <div className='container m-auto pt-20 overflow-x-hidden'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-y-5 md:gap-y-24 mb-20 pt-20 md:pt-32 px-8 sm:px-2 lg:px-20 relative'>
            ...
            <div className='w-72 justify-self-end flex justify-center items-center bg-white text-center h-20 border-4 border-custom-light-blue hover:border-custom-blue transition duration-500 text-custom-blue text-lg font-bold rounded-3xl'><p>{dict['services.card.3']}</p></div>
            <div className='md:ml-14 w-72 text-center flex justify-center items-center bg-white h-20 border-4 border-custom-light-blue text-custom-blue hover:border-custom-blue transition duration-500 text-lg font-bold rounded-3xl'><p>{dict['services.card.4']}</p></div>
