...
const CommentSection:FC<CommentSectionProps> = ({comments= []}) => {
    ...
    return <div className='relative'>
        <div className='absolute w-full top-96 left-0 -z-30'>
            <svg width="100%" height="1391" preserveAspectRatio='none' viewBox="0 0 1728 1491" fill="none" xmlns="http://www.w3.org/2000/svg">
