...
const Hero = () => {
    return <div className='h-[850px]'>
        ...
        <svg className='absolute top-0 -z-10' width="100%" height="1027" viewBox="0 0 1500 1027" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path fill-rule="evenodd" clip-rule="evenodd" d="M-156.647 -102.313C-66.7029 -99.8225 10.2397 -86.8083 79.5938 -69.6646C158.427 -50.1777 244.039 -29.8071 258.479 0.302275C274.568 33.8514 255.043 75.5743 157.812 93.4349C63.7022 110.722 -46.4974 79.9449 -156.647 76.5578C-244.646 73.8519 -339.248 90.8457 -411.951 75.915C-491.807 59.5157 -522.64 29.0389 -527.967 0.302275C-533.624 -30.2109 -517.056 -63.2479 -441.616 -84.0961C-367.754 -104.508 -257.231 -105.098 -156.647 -102.313Z" fill="#3B51FF"/>
            ...
            <path fill-rule="evenodd" clip-rule="evenodd" d="M-402.874 400.82V1027H1737.26V668.643C1618.6 723.798 1483.93 769.524 1341.32 803.596C924.577 903.168 436.998 873.163 49.2036 743.244C-182.264 665.699 -316.519 540.478 -402.874 400.82Z" fill="white"/>
            <defs>
